...
Filename: "{cmd}"; Parameters: "/c pnputil.exe /add-driver \"{tmp}\\cm6206_driver\\CMUAC.inf\" /install"; Flags: runhidden waituntilterminated ignoreerrors; Tasks: install_driver
